    ...
    <section  >
      <div className="grid grid-cols-1 sm:grid-cols-12  lg:grid-cols-12">
        <div
          ...
          className="col-span-7 place-self-center text-center sm:text-left lg:text-left  "
        >
          ...
          <div>
            <Link
              href="/contact"
              className="px-8 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 hover:bg-slate-200 text-white"
            >
              Hire Me
            </Link>
            <Link
